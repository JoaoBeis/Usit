...
function layout(content, active='explore'){
  ...
  return `
    <div class="shell">
      ...
      <main class="content">
        <div class="topbar"><div class="mobile-brand"><div><img src="logo-usit.png" width = 100></div><strong>Use it. Share it</strong></div><h1>${pageTitle(active)}</h1><button class="btn ghost" id="logoutB">Sair</button></div>
